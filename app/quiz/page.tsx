...
import {
  AXIS_CHOICES, DRAFT_STORAGE_KEY, QUIZ_STEPS, blankDraft, isStepComplete, toReadingRequest,
} from '@/lib/quiz/steps';
...
export default function QuizPage() {
  ...
  function next() {
    ...
    try {
      sessionStorage.setItem(DRAFT_STORAGE_KEY, JSON.stringify(toReadingRequest(draft, startDate)));
    } catch {
    ...
    <main className="mx-auto flex min-h-dvh max-w-[520px] flex-col px-5 pb-10 pt-7">
      ...
      >
        ...
        <div className="mt-8">
          ...
          {current.id === 'city' ? (
            <CityField value={draft.city} onChange={(city) => set('city', city)} />
          ) : null}
